			...
			<div class="fixedmain">
				...
				<div class="qbox">
					...
					<div class="checkbox" num="3" can="3" id="ss1">
						...
						<div class="xx center xx1">
							<div class="cbox ">
								<div class="nocheck">
								</div>
								<img src="img/gou.png" width="15px" />
							</div>
							<div class="text" style="    width: calc(100% - 245px);" name="you">其他 :</div>
					...
					<div class="checkbox" num="6" can="1" id="ss2">
						...
						<div class="xx center xx2">
							<div class="cbox ">
								<div class="nocheck">
								</div>
								<img src="img/gou.png" width="15px" />
							</div>
							<div class="text" style="    width: calc(100% - 245px);"  name="you">否</div>
...
iframe.parentNode.removeChild(iframe);
			...
			$(".xx").click(function(){
				...
				if(can==1){
					...
					$(this).addClass("on")
					if(index==1){
						num1=$(this).find(".text").html()
					}
					if(index==2){
						num2=$(this).find(".text").html()
					}
					if(index==4){
						num4=$(this).find(".text").html()
					}
					if(index==5){
						num5=$(this).find(".text").html()
					}
					if(index==6){
			...
			$(".tj").click(function(){
				...
				var alldeta= num1+"|"+num1+"|"+ num3+"|"+num4+"|"+num5+"|"+num6
				console.log(alldeta)
				$.ajax({
						type: "POST",
