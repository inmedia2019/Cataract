<%@ Page Language="C#" AutoEventWireup="true" CodeFile="sign_ups.aspx.cs" Inherits="sign_ups" %>
                ...
                <div class="swiper-slide">
                    ...
                    <div class="p1220">
                        ...
                        <div class="center pr ninput" style="color: #999; border-radius: 5px; background: #fff; font-size: 16px; padding: 10px 10px 10px 40px; width: calc(100% - 50px);">
							...
							<div class="center pr ninput" style="color: #999; border-radius: 5px; background: #fff; font-size: 16px; padding: 10px 10px 10px 40px; width: calc(100% - 50px);">
								<div class="center">
									<div style="width: 135px;">屈光性白内障<br /><span style="color:rgb(223, 32, 25)">手术总量</span></div>
...
$(".jxbm").click(function () {
                window.location.href="sign_ups.aspx";
            })
    </script>
   ...
   <script type="text/javascript">
       loadfx('http://jjsv.atline.cn/iCataract_line/sign_ups.aspx', '<%=fenxiang.appid%>', '<%=fenxiang.timestamp %>', '<%=fenxiang.nonceStr %>', '<%=fenxiang.signature %>', '<%=linkhead %>', "2022年度强生眼力健白内障手术达人赛")
   </script>
</body>
