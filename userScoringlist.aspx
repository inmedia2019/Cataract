<%@ Page Language="C#" AutoEventWireup="true" CodeFile="userScoringlist.aspx.cs" Inherits="userScoringlist" %>
				...
				<div class="swiper-wrapper">
					<div class="swiper-slide">
						<div class="p1220">
							...
							<div class="scorlisttitle">已点评作品</div>
							<div class="h10"></div>
							<div class="scorlist">
                            <asp:Repeater ID="rptData" runat="server">
                            <ItemTemplate>
								<a href="scoring.aspx?id=<%#Eval("Id") %>&t=1" class="ovh">
									...
									<div class="scorlistwb fr">
										<div class="scorlistwbbh">作品编号：<span><%#GetCode(Eval("Id").ToString(),Eval("code").ToString()) %></span></div>
...
$(".scorlisttopgz").click(function(){
   ...
   <script type="text/javascript">
       loadfx('http://jjsv.atline.cn/iCataract_line/userScoringlist.aspx', '<%=fenxiang.appid%>', '<%=fenxiang.timestamp %>', '<%=fenxiang.nonceStr %>', '<%=fenxiang.signature %>', '<%=linkhead %>', "2020年度强生眼力健白内障手术达人赛")
   </script>
	</body>
