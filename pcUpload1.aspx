...
<body>
    ...
    <div class="w1200 ovh">
        <div class="fl pcfl">
            ...
            <div class="bfff bor0012 p1220 f18">
                ...
                <div class="center pcinput">
                    <div class="pcinputname">
                        销售负责：</div>
                    <input type="text" id="qiangsheng" value="<%=qiangsheng %>" />
                </div>
                <div class="center pcinput">
                    <div class="pcinputname">
                        视频标题：</div>
                    <input type="text" id="videotitle" value="<%=videotitle %>" />
                </div>
                <div class="center pcinput">
                    <div class="pcinputname">
                        手术描述：</div>
                    <textarea rows="" id="descript" cols="" style="height: 100px; font: 18px/1.5 Tahoma, Helvetica, Arial,\5fae\8f6f\96c5\9ed1, sans-serif;"><%=descriptInfo %></textarea>
                </div>
                <div class="center pcinput">
                    <div class="pcinputname">
                        手术类型：</div>
                    <select id="describe">
                        ...
                        <option value="4" <%=describe=="4"?"selected='selected'":"" %>>其他</option>
                    </select>
                </div>
            ...
            <div class="bfff bor0012 p1220 f18">
                <div class="center pcinput">
                    ...
                    <div class="pcvideo ovh">
                        <div class="pcvideoup center bor5 cp pr fl">
                            <input type="hidden" id="hfVideoId" value="" />
                            <input type="hidden" id="hfVideoUrl" value="" />
                        ...
                        <div class="fl center" style="margin-left: 40px; height: 167px;">
                            <div style="width: 190px;">
                                <div class="pcsqdload center pr" style="color: #fff;">
                                    <div class="icon2" style="-webkit-transform: rotate(180deg);">
                                    </div>
                                    视频授权书上传<input type="hidden" id="hfVideoBook" value="" />
                                ...
                                <div class="pcmbdload center pr">
                                    <div class="icon2">
                                    </div>
                                    病例幻灯片上传<input type="hidden" id="hfDemo" value="" />
            ...
            <div class="center f18">
                <div class="qcqrtj cfff center cp" <%=isShow==1?"style='display:none;'":"" %>>
                    确认提交</div>
        ...
        <div class="fr pcfr">
            ...
            <div class="bfff bor0012 p1220 f18">
                <div>
	<p style="margin-bottom: 20px;">1.达人赛是强生全视今年举办的全国范围内白内障手术视频大赛，分为线上初赛、线下区域赛、11月总决赛（杭州），将分阶段有序进行。</p>
	<p style="margin-bottom: 20px;">2.线上初赛采用匿名方式，每个参赛视频将由4-5位全国知名白内障专家进行评分 & 点评。</p>
	<p>3.线上初赛分为12个区域，每个区域的前10名参赛选手进入线下区域赛；同时设立网络人气奖，每个区域得赞最高的参赛医生将获此殊荣。</p>
	</div>
                <div class="h20">
                </div>
                ...
                <a href="dow/强生全视达人赛幻灯片参考模板.pptx" class="pcmbdload center">
                    <div class="icon2">
                    </div>
                    病例模板下载 </a>
                <div class="h20">
	...
	<div class="tk" style="display: block;">
		<div class="h100 center">
			<div style="padding: 20px; height: 90%; width: 1000px; background: #fff; border-radius: 5px;">
				<div class="h100" style="overflow-y: auto; overflow-x: hidden;">
					...
					<div style="font-size: 20px; text-align: center; margin-bottom: 10px; margin-top: 30px;">
						2020年度强生全视白内障手术达人赛 线上初赛比赛规则
					</div>
					<div>
						1.达人赛是强生全视今年举办的全国范围内白内障手术视频大赛，分为线上初赛、线下区域赛、11月总决赛（杭州），将分阶段有序进行
						<br/>2.线上初赛采用匿名方式，每个参赛视频将由4-5位全国知名白内障专家进行评分 & 点评
						<br/>3.线上初赛分为12个区域，每个区域的前10名参赛选手进入线下区域赛；同时设立网络人气奖，每个区域得赞最高的参赛医生将获此殊荣
					</div>
				</div>
			</div>
		</div>
...
//            }, 15)
        ...
        $(".qcqrtj").click(function () {
            ...
            if (name == "") {
                alert_Tips("请输入姓名！", "", 1500)
                return false;
            }
            if (hospital == "") {
                alert_Tips("请输入医院！", "", 1500)
                return false;
            }
            if (province == 0) {
                alert_Tips("请选择省份！", "", 1500)
                return false;
            }
            if (qiangsheng == "") {
                alert_Tips("请输入强生全视负责销售！", "", 1500)
                return false;
            }
            if (videotitle == "") {
                alert_Tips("请输入视频标题！", "", 1500)
                return false;
            }
            if (descript == "") {
                alert_Tips("请输入手术描述！", "", 1500)
                return false;
            }
            
            if (describe == 0) {
                alert_Tips("请选择手术类型！", "", 1500)
                return false;
            }
            if (describe == "4" && describetext == "") {
                alert_Tips("请输入手术类型！", "", 1500)
                return false;
            }
            if (hfVideoId=="") {
                alert_Tips("请上传视频！", "", 1500)
                return false;
            }
            if (hfVideoBook=="") {
                alert_Tips("请上传视频授权书！", "", 1500)
                return false;
            }
            if (hfVideoBook=="-1") {
                alert_Tips("非法上传视频授权书！", "", 1500)
                return false;
            }
            if (hfDemo=="") {
                alert_Tips("请上传病例模板！", "", 1500)
                return false;
            }
            if (hfDemo=="-1") {
                alert_Tips("非法上传病例模板！", "", 1500)
                return false;
            }
            ...
            $.ajax({
                    ...
                    url: 'upVideo.aspx',
                    async: false,
                    data: { "name": name, "hospital": hospital, "province": province, "qiangsheng": qiangsheng, "videotitle": videotitle, "describe": describe, "describetext": describetext, "hfVideoId": hfVideoId, "hfVideoUrl": hfVideoUrl, "hfVideoBook": hfVideoBook, "hfDemo": hfDemo, "descript": descript },
                    beforeSend: function (xmlHttpRequest) {
                    },
                    success: function (data, textStatus) {
                        if (data == "1")
                            alert_Tips("提交成功，谢谢参与！", "", 2000)
                            //alert_Tips("上传成功,请耐心等待管理员审核！", "", 2000)
                        else if (data == "-1")
                            alert_Tips("非法请求！", "", 2000)
                        else if (data == "2")
                            alert_Tips("您已经上传,不能重复上传！", "", 2000)
                        else
                            alert_Tips("网络繁忙,请稍后再试！", "", 2000)
                    },
                    complete: function (xmlHttpRequest, textStatus) {
                    },
                    error: function () {
