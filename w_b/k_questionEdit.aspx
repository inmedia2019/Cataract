<%@ Page Language="C#" AutoEventWireup="true" CodeFile="k_questionEdit.aspx.cs" ValidateRequest="false" Inherits="k_questionEdit" %>
                        ...
                        <div class="box-content">
                            ...
                            <div class="control-group">
                                <label for="title" class="control-label">
                                    题目：</label>
                                <div class="controls">
                                    <asp:TextBox ID="txtTitle" CssClass="input-xlarge" Width="500" runat="server"></asp:TextBox>
                            ...
                            <div class="control-group" style="display:none;">
                                <label for="title" class="control-label">
                                    英文题目：</label>
                                <div class="controls">
                                   <asp:TextBox ID="txtEnTitle" CssClass="input-xlarge" Width="500" runat="server"></asp:TextBox>
                                   <span class="maroon">*</span>
                                </div>
                            </div>
                           <div class="control-group" style="display:none;">
                                ...
                                <div id="thumb_img1" class="">
                                        <img upload="image-single" id="src_en" style="max-height: 50px;" src="<%=src_en %>">
                                        <asp:HiddenField ID="picurl_en"  runat="server" />
                                        
                                   <span class="help-inline">
                                    <button name="button" class="btn select_img" type="button" onclick="upImage_en()">
                                                    选择图片</button><span class="help-inline"></span></span>
                                     <button name="button" class="btn select_img" type="button" onclick="ClearImages()">
                                                    清除图片</button>
                                </div>
                                   <script type="text/plain" id="j_ueditorupload_en" style="height:5px;display:none;" ></script>  
                                   <script>
                                       ...
                                       //实例化编辑器  
                                       var o_ueditorupload_en = UE.getEditor('j_ueditorupload_en',
                                       {
                                           autoHeightEnabled: false
                                       });
                                       o_ueditorupload_en.ready(function () {
                                           o_ueditorupload_en.hide();//隐藏编辑器  

                                           //监听图片上传  
                                           o_ueditorupload_en.addListener('beforeInsertImage', function (t, arg) {

                                               $pp = (arg[0].src);
                                               $("#src_en").attr("src", webSiteUrl + $pp);
                                               $("#picurl_en").val($pp);
                                               $("#src_en").show();
                                           });
                                       });
                                       ...
                                       function upImage_en() {
                                           ...
                                           var myImage = o_ueditorupload_en.getDialog("insertimage");
                                           myImage.open();
                                       }
                                    </script>  
                                </div>
                            ...
                            <div class="control-group">
                                <label for="title" class="control-label">
                                    题目种类：</label>
                                <div class="controls">
                                    <asp:DropDownList ID="ddlInfo" runat="server" onchange="changeInfo(this.value)">
                                        <asp:ListItem Value="0">单选题</asp:ListItem>
                                        <asp:ListItem Value="1">多选题</asp:ListItem>
                                        <asp:ListItem Value="2">文本题</asp:ListItem>
                                      <%--  <asp:ListItem Value="3">满意度题</asp:ListItem>--%>
                                    </asp:DropDownList>
                                </div>
                            </div>
                           ...
                           <div class="control-group">
                            ...
                            <div class="form-actions">
                                <asp:HiddenField ID="hfmoreCol" runat="server" />
                                <asp:HiddenField ID="hfMoreCol1" runat="server" />
