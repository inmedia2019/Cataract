<%@ Page Language="C#" AutoEventWireup="true" CodeFile="showAnswerInfo.aspx.cs" Inherits="w_b_showAnswerInfo" %>
                        ...
                        <div class="box-content nozypadding">
                            <div class="row-fluid">
                                <div class="span8 control-group">
                                    <div class="span5">
                                        <a class="btn" href="showEdit.aspx?qid=<%=qid %>&lid=<%=lid %>"><i class="icon-plus"></i>添加</a> <a class="btn"
                                            href="javascript:location.reload();"><i class="icon-refresh"></i></a>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <asp:Repeater ID="rptData" runat="server" OnItemCommand="rptData_ItemCommand" >
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input id="txtSn<%#Eval("Id") %>" type="text" style="width: 60px;" value='<%#Eval("moreCol") %>' />&nbsp;<a
                                                            href="javascript:void(0);" onclick="return setSn(<%#Eval("Id") %>)">更新</a>
                                                    </td>
                                                    <td>
                                                        <%#Eval("ainfo")%>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <a href="showEdit.aspx?id=<%#Eval("Id") %>&qid=<%=qid %>&lid=<%=lid %>" class="btn">编辑</a>
