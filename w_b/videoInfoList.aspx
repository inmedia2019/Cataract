<%@ Page Language="C#" AutoEventWireup="true" CodeFile="videoInfoList.aspx.cs" Inherits="w_b_videoInfoList" %>
                ...
                <div class="span12">
                    <div class="box">
                        <div class="box-title">
                            <div class="span8">
                                <h3>
                                    <i class="icon-table"></i>视频章节管理</h3>
                            </div>
                            <div class="span4">
                                <div class="form-horizontal">
                                    <asp:TextBox ID="txtKeyWord" CssClass="input-small-z" placeholder="章节名称" runat="server"></asp:TextBox>&nbsp;
                            ...
                            <div class="row-fluid">
                                <div class="span8 control-group">
                                    <div class="span5">
                                         ...
                                         <a class="btn" href="<%=toUrl %>">返回</a>
                                         <a class="btn" href="videoInfoEdit.aspx?tid=<%=tid %>">添加</a>
                                        ...
                                        <asp:Repeater ID="rptData" runat="server" OnItemCommand="rptData_ItemCommand" OnItemDataBound="rptData_ItemDataBound">
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <%#Eval("title")%><br />
                                                        <a href="<%=Config.webSiteUrl %>/details.aspx?id=<%#Eval("Id") %>" <%=isShow==""?"style='display:none;'":"" %> onclick="setCopy(this.href);return false;" class="btn01" target="_self">点击复制链接</a>  
                                                    </td>
                                                    <td>
                                                        <%#Eval("createDate")%>
                                                    </td>
                                                    <td>
                                                        <a href="videoInfoEdit.aspx?id=<%#Eval("Id") %>&tid=<%=tid %>" class="btn">编辑</a>
                                                        <a href="videoInfoList.aspx?tid=<%#Eval("Id") %>" class="btn" <%=isShow %> >子章节</a>
                                                        <asp:LinkButton ID="lbOut" CommandName="outPut" CssClass="btn" CommandArgument='<%#Eval("Id") %>'
                                                            runat="server">导出答题记录</asp:LinkButton>
                                                        <asp:LinkButton ID="lbTime" CommandName="outPutTime" CssClass="btn" CommandArgument='<%#Eval("Id") %>'
                                                            runat="server">导出视频观看记录</asp:LinkButton>
