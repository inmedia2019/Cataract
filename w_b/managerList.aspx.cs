...
public partial class w_b_managerList : UserPage
{
    ...
    {
        int count = 0;
        string sqlWhere = " and morecol1='" + aid + "'";



        string tbName = "y_admin";
    ...
    protected void rptData_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        if (e.Item.ItemType == ListItemType.AlternatingItem || e.Item.ItemType == ListItemType.Item)
        {
            ...
            {
                bool result = new y_adminDAL().Delete(Utils.ToInt(e.CommandArgument));
                if (result == true)
                {
    ...
    {
        bool result = new y_adminDAL().DeleteList(hfIds.Value.Substring(0, hfIds.Value.Length - 1));
        if (result == true)
        {
