<%@ Page Language="C#" AutoEventWireup="true" CodeFile="posterEdit.aspx.cs" ValidateRequest="false" Inherits="w_b_posterEdit" %>
                            ...
                            <div class="box-content">
                                ...
                                <div class="control-group" >
                                    <label for="title" class="control-label">
                                        医院：</label>
                                    <div class="controls">
                                        <asp:TextBox ID="txtYiYuan" CssClass="input-xlarge" Width="400" runat="server"></asp:TextBox>
                                        <span class="maroon">*</span>
                                    </div>
                                </div>
