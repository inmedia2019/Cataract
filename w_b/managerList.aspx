<%@ Page Language="C#" AutoEventWireup="true" CodeFile="managerList.aspx.cs" Inherits="w_b_managerList" %>
                ...
                <div class="span12">
                    <div class="box">
                        <div class="box-title">
                            <div class="span8">
                                <h3>
                                    <i class="icon-table"></i>审核账号管理</h3>
                            </div>
                            ...
                            <div class="row-fluid">
                                <div class="span8 control-group">
                                    <div class="span5">
                                         ...
                                         <a class="btn" href="managerEdit.aspx?aid=<%=aid %>">添加</a>
                                    </div>
                                </div>
                            </div>
                            -
                                            ...
                                            <ItemTemplate>
                                                <tr>
                                                    <td class="with-checkbox">
                                                        <input type="checkbox" class="check_all" value='<%#Eval("userid") %>'>
                                                    </td>
                                                    <td>
                                                        <%#Eval("username")%>
                                                    </td>
                                                    <td>
                                                       <%#new General.SymmetricMethod().Decrypto(Eval("pwd").ToString())%>
                                                    </td>
                                                    <td>
                                                        <%#Eval("createDate")%>
                                                    </td>
                                                    <td>
                                                        <a href="managerEdit.aspx?id=<%#Eval("userid") %>&aid=<%=aid %>" class="btn">编辑</a>
                                                        <asp:LinkButton ID="lbDel" CommandName="del" CssClass="btn" OnClientClick="return confirm('确认删除?')" CommandArgument='<%#Eval("userid") %>'
