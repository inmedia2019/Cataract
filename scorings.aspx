				...
				<div class="qbox">
					...
					<div class="checkbox" num="3" can="3" id="ss1">
						<div class="xx center">
							...
							<div class="text" name="5">参赛选手及视频的数量</div>
						</div>
						<div class="xx center ">
							<div class="cbox ">
								<div class="nocheck">
							...
							<div class="text" name="4">参赛视频的质量</div>
						</div>
						<div class="xx center ">
							<div class="cbox ">
								<div class="nocheck">
							...
							<div class="text" name="3">评分标准规则的公平公正</div>
						</div>
						<div class="xx center ">
							<div class="cbox ">
								<div class="nocheck">
							...
							<div class="text" name="2">活动形式的创新与不同</div>
						</div>
						<div class="xx center ">
							<div class="cbox ">
								<div class="nocheck">
...
//					});
		...
		<script type="text/javascript">
		    loadfx('https://wx.linkmed.cn/iCataract_line/scoring.aspx?id=<%=id %>', '<%=fenxiang.appid%>', '<%=fenxiang.timestamp %>', '<%=fenxiang.nonceStr %>', '<%=fenxiang.signature %>', '<%=linkhead %>', "2020年度强生眼力健白内障手术达人赛")
		</script>
	</body>
