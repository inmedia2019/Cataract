...
<meta charset="UTF-8">
        ...
        <style type="text/css">
            #body,#bodys {
                ...
                .shjdBox{}
.shjdBox .iconfont{color: #9a9999;}
.shjdBox .iconfont.on{ color: #de1f26; }
        </style>
                    ...
                    <div class="swiper-slide">
                        <ul id="" class="mylist">
                          <asp:Repeater ID="rptData" runat="server">
                        	...
                        	<li>
								<div class="center">
									<div class="scorlistimg center pr" style="background: url(img/jx1.png) center no-repeat; background-size:cover; width: 150px;">
									...
									<div style="margin-left: 10px; width: calc(100% - 155px);">
										...
										<div class="ovh">
                                            <div class="center fl shjd" style=" margin-top: 5px; width: 70px; background: #999; color: #fff; height: 28px; border-radius: 5px; ">
											    审核进度
										    </div>
                                            <div class="center fl pwpf" style=" margin-top: 5px; width: 70px; background: #999; color: #fff; height: 28px; border-radius: 5px; margin-left:10px; ">
											    评委评分
										    </div>
                                        </div>
									</div>
								</div>
								<div class="shjdBox f12 dn">
									<div class="h10"></div>
									<div class="h10"></div>
									<div class="center">
										<div class="">
                                ...
                                <div class="pwpfBox f12 dn">
									<div class="h10"></div>
									<div class="h10"></div>

								    <%#GetScore(Eval("Id").ToString()) %>
...
function loadVideo()
		 ...
		 loadVideo()
            ...
            $(".zjpybut").click(function(){

                 $(".zjpynr").hide()
                 $(".zjpybut").css({"background":"#999"})

                 $(this).css({"background":"#de1f26"})
                 $(this).parent().find(".zjpynr").show()
            ...
            $(".shjd").click(function(){
                ...
                $(".shjd").css({"background":"#de1f26"})
                $(".pwpf").css({"background":"#999"})

				$(".mylist li .pwpfBox").addClass("dn")
				
				if($(this).parent().parent().parent().parent().find(".shjdBox").hasClass("dn")){
					$(this).parent().parent().parent().parent().find(".shjdBox").removeClass("dn")
				}
			})
			
			$(".pwpf").click(function(){
                $(".pwpf").css({"background":"#de1f26"})
                $(".shjd").css({"background":"#999"})

				$(".mylist li .shjdBox").addClass("dn")


				
				if($(this).parent().parent().parent().parent().find(".pwpfBox").hasClass("dn")){
					$(this).parent().parent().parent().parent().find(".pwpfBox").removeClass("dn")
				}
			})
        </script>
